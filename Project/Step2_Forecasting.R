...
train_test_split(z_ts, split_perc = 0.85)
...
#NB: it's clear m=7 would be the seasonal comp. of our ARIMA model.
...
#using the msts ojbect with multiple seasonalities specified, 
